...
dq-compass/
│
├── dq-compass-app/             ✨ NOUVELLE APPLICATION STREAMLIT
│   ├── app.py                  # Page d'accueil
│   ├── pages/
│   │   ├── 1_📊_Upload_Data.py      # Étape 1 : Upload CSV
│   │   ├── 2_📝_Define_Rules.py     # Étape 2 : Formulaire de règles
│   │   └── 3_📈_Quality_Report.py   # Étape 3 : Rapport visuel
...
```
┌─────────────────────────────────────────────────────────┐
│  FRONTEND : Streamlit (dq-compass-app/)                 │
│  - Interface no-code                                     │
